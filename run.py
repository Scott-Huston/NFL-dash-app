...
navbar = dbc.NavbarSimple(
    ...
    children=[
        ...
        dbc.NavItem(dcc.Link('Case Study', href='/case_study', className='nav-link', style={'color': '#FFFFFF'})), 
        dbc.NavItem(dcc.Link('Model', href='/model', className='nav-link', style={'color': '#FFFFFF'})), 
    ],
    sticky='top',
    color='#013F8E', 
    light=True,
